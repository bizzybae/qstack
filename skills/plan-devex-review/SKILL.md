...
- project custom instructions for project conventions
...
- Mentions SKILL.md, skill template, Perplexity Computer, AI agent, MCP → **Perplexity Computer Skill**
...
Load reference: Read the "## Pass 1" section from `plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 2" section from `plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 3" section from `plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 4" section from `plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 5" section from `plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 6" section from `plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 7" section from `plan-devex-review/dx-hall-of-fame.md`.
...
Load reference: Read the "## Pass 8" section from `plan-devex-review/dx-hall-of-fame.md`.
...
### Appendix: Perplexity Computer Skill DX Checklist

**Conditional: only run when product type includes "Perplexity Computer skill".**

This is NOT a scored pass. It's a checklist of proven patterns from qstack's own DX.

Load reference: Read the "## Perplexity Computer Skill DX Checklist" section from
`plan-devex-review/dx-hall-of-fame.md`.
...
`(qstack memory) ` (user config directory, not project files).
