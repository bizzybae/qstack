...
Use screenshot_page to capture the page -a -o ".qstack/canary-reports/baselines/<page-name>.png"
...
Save the baseline manifest to `.qstack/canary-reports/baseline.json`:
...
```bash
Use browser_task to navigate to <page-url>
Use screenshot_page to capture the page -a -o ".qstack/canary-reports/screenshots/pre-<page-name>.png"
Use browser_task: console --errors
Use browser_task: perf
```
...
```bash
Use browser_task to navigate to <page-url>
Use screenshot_page to capture the page -a -o ".qstack/canary-reports/screenshots/<page-name>-<check-number>.png"
Use browser_task: console --errors
Use browser_task: perf
```
...
Screenshots:   .qstack/canary-reports/screenshots/

VERDICT: [DEPLOY IS HEALTHY / DEPLOY HAS ISSUES — details above]
```

Save report to `.qstack/canary-reports/{date}-canary.md` and `.qstack/canary-reports/{date}-canary.json`.
