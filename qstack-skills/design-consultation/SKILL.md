...
```bash
Use browser_task to navigate to "https://example-site.com"
Use browser_task: screenshot "/tmp/design-research-site-name.png"
...
This phase generates visual previews of the proposed design system. Two paths depending on whether the qstack designer is available.
...
**Update project custom instructions** (or create it if it doesn't exist) — append this section:
...
- A) Ship it — write DESIGN.md and project custom instructions
